...
```
 ...
 - Example 1. First, let's build a simple app that takes a numeric input n (`numericInput`), and draws a n random normal samples. Then, display a histogram of the draws by rendering the plot (`renderPlot`)
